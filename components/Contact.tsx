...
import { Mail, ArrowUpRight, Github, Twitter, Linkedin, CheckCircle2, Copy, ExternalLink } from 'lucide-react';
            ...
            <div className="relative">
              <AnimatePresence mode="wait">
                {status === 'success' ? (
                  ...
                  >
                    <div className="w-20 h-20 bg-emerald-500 rounded-full flex items-center justify-center text-black mb-6">
                      <CheckCircle2 size={40} />
                    </div>
                    <h4 className="text-3xl font-bold text-white mb-2 tracking-tighter">Transmission Received.</h4>
                  ...
                  >
                    ...
                    >
                      <span className="relative z-10 flex items-center gap-3">
                        {status === 'submitting' ? 'SYNCHRONIZING...' : 'INITIALIZE CONNECTION'}
